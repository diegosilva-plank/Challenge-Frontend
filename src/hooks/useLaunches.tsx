...
export const useLaunches = () => {
  ...
  const showModalToggle = (
    ...
    setLaunch?: (value: React.SetStateAction<ILaunch>) => void,
    launch?: ILaunch
  ) => {
    return () => {
  ...
  const showMoreInfoModalToggle = (launch: ILaunch) =>
    showModalToggle(setShowMoreInfoModal, setLaunchMoreInfoModal, launch)
  const showEditLaunchModalToggle = (launch: ILaunch) =>
    showModalToggle(setShowEditLaunchModal, setLaunchEditModal, launch)
  const showDeleteLaunchModalToggle = (launch: ILaunch) =>
    showModalToggle(setShowDeleteLaunchModal, setLaunchDeleteModal, launch)
