...
export const useCrewmen = () => {
  ...
  const [crewmanSeeCrewsModal, setCrewmanSeeCrewsModal] = useState(
    {} as ICrewman
  )
  ...
  const showModalToggle = (
    ...
    setCrewman?: (value: React.SetStateAction<ICrewman>) => void,
    crewman?: ICrewman
  ) => {
    return () => {
  ...
  const showSeeCrewsModalToggle = (crewman: ICrewman) =>
    showModalToggle(setShowSeeCrewsModal, setCrewmanSeeCrewsModal, crewman)
  const showEditCrewmanModalToggle = (crewman: ICrewman) =>
    showModalToggle(setShowEditCrewmanModal, setCrewmanEditModal, crewman)
  const showDeleteCrewmanModalToggle = (crewman: ICrewman) =>
    showModalToggle(setShowDeleteCrewmanModal, setCrewmanDeleteModal, crewman)
