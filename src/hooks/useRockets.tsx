...
export const useRockets = () => {
  ...
  const showModalToggle = (
    ...
    setRocket?: (value: React.SetStateAction<IRocket>) => void,
    rocket?: IRocket
  ) => {
    return () => {
  ...
  const showEditRocketModalToggle = (rocket: IRocket) =>
    showModalToggle(setShowEditRocketModal, setRocketEditModal, rocket)
  const showDeleteRocketModalToggle = (rocket: IRocket) =>
    showModalToggle(setShowDeleteRocketModal, setRocketDeleteModal, rocket)
  const showLaunchRocketModalToggle = (rocket: IRocket) =>
    showModalToggle(setShowLaunchRocketModal, setRocketLaunchModal, rocket)
