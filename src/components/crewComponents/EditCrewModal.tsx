        ...
        <Modal close={props.close}>
            <div className="input-div-ctn">
                <div className="input-div">
                    <label>Name:</label>
                    <input type="text" placeholder={props.crew.name} onChange={handleChange} />
                </div>
            </div>
            <div className="btn-div">
                <div className="btn btn-red" onClick={props.close}>Cancel</div>
                <div className="btn btn-green" onClick={props.editCrew(props.crew.id, nameInput)}>Confirm</div>
            </div>
        </Modal>
    )
}