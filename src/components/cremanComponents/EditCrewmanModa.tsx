...
interface EditCrewmanModalProps {
    ...
    editCrewman: (id: string, name: string, patent: string) => MouseEventHandler<HTMLDivElement>
}
        ...
        <Modal close={props.close}>
            <div className="input-div-ctn">
                <div className="input-div">
                    <label>Name:</label>
                    <input type="text" placeholder={props.crewman.name} onChange={handleChangeName} />
                </div>
            </div>
            <div className="input-div-ctn">
                <div className="input-div">
                    <label>Patent:</label>
                    <input type="text" placeholder={props.crewman.patent} onChange={handleChangePatent} />
                </div>
            </div>
            <div className="btn-div">
                <div className="btn btn-red" onClick={props.close}>Cancel</div>
                <div className="btn btn-green" onClick={props.editCrewman(props.crewman.id, nameInput, patentInput)}>Confirm</div>
            </div>
        </Modal>
    )
}